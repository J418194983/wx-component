...
var Previewer = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Previewer, [{
    ...
    value: function render() {
      ...
      }))), !((_this$props$hideActio4 = this.props.hideActions) === null || _this$props$hideActio4 === void 0 ? void 0 : _this$props$hideActio4.includes('CSB')) && path && /*#__PURE__*/_react.default.createElement(_umi.Link, {
        target: "_blank",
        to: path
      }, /*#__PURE__*/_react.default.createElement("button", {
        className: "__dumi-default-icon",
